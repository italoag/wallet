...
@SpringBootApplication(exclude = {
                // Excluded because spring-statemachine 4.0.1 references old Spring Boot 3.x
                // autoconfigure class
                StateMachineJpaRepositoriesAutoConfiguration.class
}, excludeName = {
                // Exclude R2DBC repository auto-config to prevent scanning JPA repositories
                "org.springframework.boot.autoconfigure.data.r2dbc.R2dbcRepositoriesAutoConfiguration",
                // Exclude Redis repository auto-config to prevent scanning JPA repositories
