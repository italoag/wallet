 ...
 * <li>Parent-child span relationships (consumer span as child of producer
 * span)</li>
 ...
 * </tr>
 * <tr>
 * <td>messaging.kafka.consumer.group</td>
 * <td>Consumer group ID</td>
 * <td>wallet-service</td>
 * </tr>
 * <tr>
 * <td>messaging.consumer_lag_ms</td>
 * <td>Time from send to receive</td>
 * <td>125</td>
 * </tr>
 * <tr>
 ...
 * <li>{@code deserialization.completed} - After deserialization (includes
 * size)</li>
 ...
 * </pre>
 * 
 * This requires producers to use
 ...
 * {@link dev.bloco.wallet.hub.infra.adapter.tracing.propagation.CloudEventTracePropagator}
 * which extracts trace context from CloudEvent extensions and creates child
 * spans.
 *
...
public class KafkaConsumerObservationHandler implements ObservationHandler<Observation.Context> {
     ...
     * 
     * <p>
     * This handler processes Kafka consumer observations from Spring Cloud Stream
     * and Spring Kafka's @KafkaListener operations.
     * </p>
     *
     ...
     * 
     * <p>
     * Creates CONSUMER span and adds initial messaging attributes.
     * Records deserialization start event.
     * </p>
     *
     * @param context the observation context
     */
