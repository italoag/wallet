...
class WithdrawFundsUseCaseTest {
    ...
    @Test
    @DisplayName("withdrawFunds updates wallet, saves transaction, and publishes event")
    void withdrawFunds_success() {
        ...
        assertThat(tx.getType()).isEqualTo(Transaction.TransactionType.WITHDRAWAL);
        assertThat(tx.getFromWalletId()).isEqualTo(wallet.getId());
