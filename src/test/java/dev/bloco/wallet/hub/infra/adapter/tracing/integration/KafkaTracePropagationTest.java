 ...
 * 
 * <p>
 * Tests W3C Trace Context propagation via CloudEvents extensions,
 * span hierarchy, consumer lag calculation, and trace continuity across event
 * cascades.
 * </p>
 * 
 * <p>
 * Validates:
 * <ul>
 * <li>T086: Trace context in CloudEvent extensions (traceparent format:
 * 00-{trace-id}-{span-id}-01)</li>
 * <li>T087: Consumer span as child of producer span</li>
 * <li>T088: Consumer lag calculation from timestamps</li>
 * <li>T089: Trace continuity across event cascades (FundsAdded →
 * FundsTransferred)</li>
 * </ul>
 */
@Testcontainers
